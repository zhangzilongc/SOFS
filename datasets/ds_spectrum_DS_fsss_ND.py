...
from datasets.dataset_split import DS_Spectrum_DS_split_test_dict
...
class DS_Spectrum_DS_FSSS_ND(BASE_DATASET_FSSS_ND):
    ...
    def __init__(
        ...
        """
        assert self.mode == "test", "mode must be test"
        target_split_list = DS_Spectrum_DS_split_test_dict[self.data_split]
